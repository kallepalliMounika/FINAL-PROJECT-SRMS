...
urlpatterns = [
    ...
    path('Teacher/Welcome/same/<name_id>/',Teacher_o,name = 'Teacher_o'),
    path('Student/Welcome/same/<Roll_Number>/',Student_o,name = 'Student_o'),
    path('Homepage/Welcome/same/',faculty,name = 'faculty'),
